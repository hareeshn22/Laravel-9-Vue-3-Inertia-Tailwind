      ...
      <div>
        <nav class="flex h-9 items-center justify-between" aria-label="Global">
          ...
          <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
                ...
                <Link :href="route('login')" class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20">Log in</Link>
                <a class="mx-1"></a>
                <Link
                    v-if="canRegister"
                    :href="route('register')"
